...
import type { BodySystem as _BodySystem, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createBlogPost(arg0: string, arg1: string, arg2: string, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createBodySystem(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createBodySystem(arg0, arg1, arg2, arg3, arg4, arg5, arg6, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg7));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createMCQ(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createMCQ(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteBodySystem(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteBodySystem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllBodySystems(): Promise<Array<BodySystem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBodySystems();
    ...
    async getBodySystemsByDisorder(): Promise<Array<BodySystem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBodySystemsByDisorder();
                return from_candid_vec_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBodySystemsByFunction(): Promise<Array<BodySystem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBodySystemsByFunction();
                return from_candid_vec_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBodySystemsByStructure(): Promise<Array<BodySystem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBodySystemsByStructure();
                return from_candid_vec_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBlogPost(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateBodySystem(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBodySystem(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg8));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMCQ(arg0: bigint, arg1: bigint, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMCQ(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BodySystem_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BodySystem): BodySystem {
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        functionText: value.functionText,
        name: value.name,
        slug: value.slug,
        description: value.description,
        neetPoints: value.neetPoints,
        commonDisorders: value.commonDisorders,
        diagramUrl: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.diagramUrl)),
        structureText: value.structureText
    };
}
...
function from_candid_vec_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_BodySystem>): Array<BodySystem> {
    return value.map((x)=>from_candid_BodySystem_n5(_uploadFile, _downloadFile, x));
}
